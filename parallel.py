...
class DataLoader:
    ...
    PICKLE_FILE = 'data/data_file.pickle'
    ...
    def loadTimeStamps(self):
        with open(DataLoader.DISTANCE_FILE, 'rb') as jfile:
    ...
    def saveTimeStamps(self):
        with open(DataLoader.DISTANCE_FILE, 'wb') as jfile:
...
def slicePlayground(trips, limits, radius, nodes):
    ...
    # Obteniendo franjas, trabajados en metros
    ...
    # Ubicando los puntos en sus areas
...
def sanitizeData(trips):
    # Normalizando mediciones de acelerometro   2.
    acelerometro = dict()
...
def getAreaStatus(slices):
    ...
    # Toma del radio del punto y promedia     3.c
    averages = list()
...
if rank == 0:
    ...
    # Buscando limites de areas construidas
